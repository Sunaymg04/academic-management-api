...
<!-- 🟣 PRIMERO -->
<p style="font-family: Arial; font-size: 12pt;">
<strong>PRIMERO:</strong> Ratificar a los compañeros que a continuación se presentan como Profesores Principales de Año (PPA) de {{ $nombreFacultad }} para el curso {{ $camposEditables['cursoResolucion'] ?? $anio }} en el Curso Diurno.
</p><br/>
...
<!-- 🟣 Segunda -->
<p style="font-family: Arial; font-size: 12pt;">
<strong>SEGUNDO:</strong> Desnombrar a los compañeros que a continuación se presentan como Profesores Principales de Año (PPA) de {{ $nombreFacultad }} para el curso {{ $camposEditables['cursoResolucion'] ?? $anio }} en el curso diurno.
</p>
<br/>
...
<!-- 🟣 Tercero -->
<p style="font-family: Arial; font-size: 12pt;">
<strong>TERCERO:</strong> Designar a los compañeros que a continuación se presentan como Profesores Principales de Año (PPA) de {{ $nombreFacultad }} para el curso {{ $camposEditables['cursoResolucion'] ?? $anio }} en el Curso Diurno.
</p><br/>
...
<p style="font-family: Arial; font-size: 12pt;">
<strong>ARCHÍVESE</strong> en la Universidad Central “Marta Abreu” de Las Villas, a los {{ $camposEditables['diaArchivese'] ?? $dia }} días del mes de {{ $camposEditables['mesArchivese'] ?? $mes }} de {{ $camposEditables['anioArchivese'] ?? $anio }}. “{{ $camposEditables['revolucionTexto'] ?? ('AÑO '.$revolucion.' DE LA REVOLUCION') }}”.
</p><br/>
