...
Route::get('/plan_estudio/vicerrector/solicitudes', [PlanEstudioController::class, 'solicitudesVicerrector']);
Route::get('/plan_estudio/vicerrector/historial', [PlanEstudioController::class, 'historialSolicitudesVicerrector']);
...
Route::post('/plan_estudio/{id}/vicerrector/aprobar', [PlanEstudioController::class, 'aprobarVicerrector']);
Route::post('/plan_estudio/{id}/vicerrector/cancelar', [PlanEstudioController::class, 'cancelarVicerrector']);
